...
am__tests_ovstest_SOURCES_DIST = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-vconn.c tests/test-aa.c tests/test-unix-socket.c \
	tests/test-netlink-conntrack.c
...
am__noinst_HEADERS_DIST = CONTRIBUTING.md CodingStyle.md DESIGN.md \
	...
	tests/vlan-splinters.at tests/ofproto.at tests/netdev-type.at \
...
ACLOCAL = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing automake-1.15
AWK = mawk
CAPNG_LDADD = 
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
PACKAGE_STRING = openvswitch 2.5.4
...
abs_builddir = /home/tmc/openvswitch-2.5.4
abs_srcdir = /home/tmc/openvswitch-2.5.4
abs_top_builddir = /home/tmc/openvswitch-2.5.4
abs_top_srcdir = /home/tmc/openvswitch-2.5.4
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/tmc/openvswitch-2.5.4/build-aux/install-sh
...
tests_ovstest_SOURCES = tests/ovstest.c tests/ovstest.h \
	...
	tests/test-sflow.c tests/test-sha1.c tests/test-stp.c \
	tests/test-util.c tests/test-uuid.c tests/test-bitmap.c \
	tests/test-vconn.c tests/test-aa.c $(am__append_40) \
	$(am__append_41)
...
$(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/selinux/automake.mk $(am__empty):
